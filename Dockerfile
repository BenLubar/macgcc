...
RUN apt-get update \
 && apt-get install -y --no-install-recommends clang libmpc-dev libmpfr-dev libgmp-dev libxml-libxml-perl libxml-libxslt-perl python3-sphinx \
 ...
 && curl "https://cmake.org/files/v3.9/cmake-3.9.4-Linux-x86_64.tar.gz" | tar xzC "/opt/cmake" --strip-components=1 \
 && cd /osxcross \
